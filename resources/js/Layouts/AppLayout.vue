    ...
    <div>
        ...
        <div class="min-h-screen">
            <nav>
                ...
                <div
                    class="max-w-7xl bg-background mx-auto sm:mt-8 border-t border-x border-white rounded-t-lg relative border-double__header-top">
                ...
                <header v-if="$slots.header"
                        class="bg-background-light max-w-7xl mx-auto shadow-xl border-x border-b border-white rounded-b-lg border-double__header-bottom relative">
